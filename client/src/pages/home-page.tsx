            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h1 className="text-3xl font-bold" data-testid="text-welcome" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Welcome back, Brother {(dashboard as any)?.user?.firstName || ''}.
                  </h1>
                </div>
                <p className="text-primary-foreground/90 text-lg">Ready to take up the work? Begin a session with the Cardinal Tutor.</p>
              </div>
            </div>
          </div>
