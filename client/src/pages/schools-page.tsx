          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-foreground leading-tight">
                Phi Sigma Kappa Tutor™ — AI Tutoring for Schools
              </h1>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <AccordionItem value="cheating" className="bg-card border border-border rounded-xl px-6">
                ...
                <AccordionContent className="text-muted-foreground pb-4">
                  Phi Sigma Kappa Tutor uses a Socratic method — the tutor asks guiding questions to help students 
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg text-muted-foreground">
              Learn how Phi Sigma Kappa Tutor can support student success in your district.
            </p>
