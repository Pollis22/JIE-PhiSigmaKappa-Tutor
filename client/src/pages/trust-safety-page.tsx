    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl flex-grow">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <h1 className="text-4xl font-bold mb-4">Trust, Safety & Compliance at Phi Sigma Kappa Tutor</h1>
          
          <p className="text-lg text-muted-foreground mb-8">
            At Phi Sigma Kappa Tutor ("Phi Sigma Kappa Tutor", "we", "us"), trust is not a feature – it's the product.
          ...
          <section className="mb-10">
            ...
            <p className="text-lg font-semibold mb-3">Phi Sigma Kappa Tutor is built to teach, not to cheat.</p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Limited use of data.</strong> Data is used only to:
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>Deliver and improve the Phi Sigma Kappa Tutor tutoring experience,</li>
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">Phi Sigma Kappa Tutor is designed to support compliance with key US education privacy laws and state requirements.</p>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>For children under 13 using Phi Sigma Kappa Tutor through a school, the school or district can provide consent on behalf of parents where allowed by law.</li>
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">We are committed to making Phi Sigma Kappa Tutor accessible to as many learners as possible.</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-10">
            ...
            <p className="mt-4">We take every inquiry seriously and work directly with your IT, legal, or compliance teams to ensure Phi Sigma Kappa Tutor fits your requirements.</p>
          </section>
        </div>
      </div>
