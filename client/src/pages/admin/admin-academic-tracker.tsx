          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="A message from your academic advisor — Phi Sigma Kappa Tutor"
              />
            </div>
            <div>
              <Label>Message *</Label>
              <Textarea
                ...
                placeholder="Hi! We noticed you haven't been active recently. Your Phi Sigma Kappa Tutor is here to help you succeed..."
              ...
              onClick={() => {
                if (showNudgeDialog && nudgeMessage) {
                  nudgeMutation.mutate({
                    ...
                    subject: nudgeSubject || "A message from your academic advisor — Phi Sigma Kappa Tutor",
