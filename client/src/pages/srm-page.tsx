    ...
    <div className="relative flex gap-5 md:gap-6">
      <div className="flex flex-col items-center flex-shrink-0">
        <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg"
          style={{ background: "#B71234", boxShadow: "0 4px 14px rgba(183,18,52,0.3)" }}>
          {number}
        </div>
        {number < 5 && <div className="w-px flex-1 mt-2" style={{ background: "linear-gradient(to bottom, #B71234, transparent)" }} />}
      </div>
      <div className="pb-10">
  ...
  return (
    <div className="min-h-screen" style={{ background: "#FFFFFF", fontFamily: "'Red Hat Text', 'Source Sans 3', sans-serif" }}>
      ...
      <section className="relative overflow-hidden" style={{ paddingTop: 100, paddingBottom: 60 }}>
        ...
        <div className="absolute top-20 right-0 w-96 h-96 rounded-full opacity-[0.04]" style={{ background: "#B71234", filter: "blur(120px)" }} />

        <div className="relative max-w-6xl mx-auto px-4 md:px-12">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6"
              style={{ background: "rgba(183,18,52,0.06)", border: "1px solid rgba(183,18,52,0.12)" }}>
              <Calendar className="w-4 h-4" style={{ color: "#B71234" }} />
            ...
            <div className="flex flex-wrap gap-3">
              {user ? (
                <Button onClick={() => setLocation("/academic-dashboard")}
                  ...
                  style={{ background: "#B71234", boxShadow: "0 4px 20px rgba(183,18,52,0.3)" }}>
              ...
              <Button variant="outline" onClick={() => document.getElementById("how-it-works")?.scrollIntoView({ behavior: "smooth" })}
                ...
                style={{ borderColor: "#B71234", color: "#B71234" }}>
                See How It Works
              </Button>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#FAFAFA" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            {/* With SRM */}
            <div className="rounded-2xl p-7" style={{ background: "#FFFFFF", border: "2px solid #B71234", boxShadow: "0 4px 20px rgba(183,18,52,0.08)" }}>
              <div className="flex items-center gap-3 mb-5">
      ...
      <section id="how-it-works" className="py-16 md:py-20 px-4 md:px-12 scroll-mt-20" style={{ background: "#FFFFFF" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="ml-2 md:ml-8">
            <SRMStep number={1} icon={<Upload className="w-5 h-5" style={{ color: "#B71234" }} />}
            ...
            <SRMStep number={2} icon={<Calendar className="w-5 h-5" style={{ color: "#B71234" }} />}
            ...
            <SRMStep number={3} icon={<CheckSquare className="w-5 h-5" style={{ color: "#B71234" }} />}
            ...
            <SRMStep number={4} icon={<Mic className="w-5 h-5" style={{ color: "#B71234" }} />}
            ...
            <SRMStep number={5} icon={<BarChart3 className="w-5 h-5" style={{ color: "#B71234" }} />}
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #E8E8E8", boxShadow: "0 8px 40px rgba(0,0,0,0.06)" }}>
            ...
            <div className="p-7 md:p-10" style={{ background: "linear-gradient(135deg, #FFF7ED 0%, #FFF 100%)" }}>
              ...
              <p style={{ fontSize: 16, color: "#646569", lineHeight: 1.65, marginBottom: 28, maxWidth: 600 }}>
                Other AI tools answer questions. Your Phi Sigma Kappa Tutor opens the conversation with what matters most — because it sees your entire academic picture.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="rounded-xl p-5" style={{ background: "rgba(183,18,52,0.03)", border: "2px solid rgba(183,18,52,0.15)" }}>
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: "#28A745" }} />
                    <span style={{ fontSize: 13, fontWeight: 600, color: "#B71234" }}>Phi Sigma Kappa Tutor + SRM</span>
                  </div>
                  <div className="rounded-lg p-4" style={{ background: "rgba(183,18,52,0.04)" }}>
                  ...
                  <p className="mt-3" style={{ fontSize: 12, color: "#B71234", fontWeight: 600 }}>Full academic awareness. Proactive guidance. Personal advisor.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-7 md:p-10" style={{ background: "#FFFFFF", border: "1px solid #E8E8E8" }}>
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(183,18,52,0.08)" }}>
              ...
              <div className="w-full md:w-72 flex-shrink-0 rounded-xl p-5" style={{ background: "#FEF7F7", border: "1px solid rgba(183,18,52,0.1)" }}>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#B71234", marginBottom: 12, textTransform: "uppercase", letterSpacing: 0.5 }}>Alert Types</p>
                <div className="space-y-3">
                  {[
      ...
      <section className="py-16 md:py-20 px-4 md:px-12" style={{ background: "#FFFFFF" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { label: "Sessions", weight: "40%", desc: "Tutoring sessions completed vs target (3/week per course)", color: "#B71234" },
      ...
      <footer className="py-8 md:py-10 px-4 md:px-12 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4" style={{ borderTop: "1px solid #E8E8E8", background: "#FFFFFF" }}>
        <div className="flex items-center gap-3">
          <img src={suLogo} alt="Phi Sigma Kappa" className="h-8 object-contain" />
          <span style={{ fontSize: 12, color: "#646569" }}>Phi Sigma Kappa · AI Tutor Program</span>
        </div>
        <span style={{ fontSize: 11, color: "#DAD7CB" }}>Phi Sigma Kappa · AI Tutor Program</span>
      </footer>
    </div>
  );
}
