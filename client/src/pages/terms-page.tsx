    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setLocation("/auth")}>
              <img src={suLogo} alt="Phi Sigma Kappa Tutor" className="h-10 w-auto" />
              <span className="text-xl font-bold text-foreground">Phi Sigma Kappa Tutor</span>
            </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p className="text-xl font-semibold mb-8">Phi Sigma Kappa Tutor AI - AI-Powered Educational Tutoring Services</p>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">1. Acceptance of Terms</h2>
            <p>By creating an account, subscribing to, or using Phi Sigma Kappa Tutor AI ("Service," "we," "us," or "our"), you agree to be bound by these Terms and Conditions. If you do not agree, you may not use our Service.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">2. Description of Service</h2>
            <p>Phi Sigma Kappa Tutor AI provides AI-powered voice tutoring in Math, English, Science, and Spanish for students from Kindergarten through College/Adult levels. Our Service includes:</p>
          ...
          <section className="mb-8">
            ...
            <p>All content provided by Phi Sigma Kappa Tutor AI, including AI tutor responses, interface design, and software, is our intellectual property and protected by copyright and other laws.</p>
          ...
          <section className="mb-8">
            ...
            <p>To the maximum extent permitted by law, Phi Sigma Kappa Tutor AI shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or educational opportunities.</p>
          ...
          <section className="mb-8">
            ...
            <p>These Terms constitute the entire agreement between you and Phi Sigma Kappa Tutor AI regarding the Service.</p>
      ...
      <footer className="bg-card border-t border-border py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-muted-foreground">&copy; 2025 Phi Sigma Kappa Tutor. All rights reserved.</p>
