...
export default function OfferPage() {
  ...
  useEffect(() => {
    ...
    if (isHomepage) {
      document.title = "Phi Sigma Kappa Tutor — Voice Tutoring Worthy of the Brotherhood | College & Graduate Scholarship";
    } else {
      document.title = "Free Trial + 50% Off | Phi Sigma Kappa Tutor";
...
{/* LCP element (mobile): Hero heading - renders immediately with system fonts while webfonts load */}
          ...
          <div className="max-w-2xl mx-auto">
            <Accordion type="single" collapsible className="space-y-2">
              {[
                ...
                { q: "Does it give answers or teach?", a: "Phi Sigma Kappa Tutor uses the Socratic method to guide students through problems step-by-step. It's real homework help for students—teaching thinking, not just answers." },
                { q: "What subjects are included?", a: "Mathematics, the humanities, the sciences, and twenty-five languages — all supported. The tutor covers undergraduate coursework and graduate test preparation (GRE, GMAT, LSAT, MCAT)." },
                { q: "Is this good for homeschool families?", a: "Absolutely! Phi Sigma Kappa Tutor works as an AI tutor for homeschool students, providing on-demand online homeschool tutoring that adapts to any curriculum." }
              ].map((item, idx) => (
      ...
      <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4 text-center space-y-6">
          <h2 className="text-2xl md:text-3xl font-bold">Try Phi Sigma Kappa Tutor Risk-Free</h2>
          <StartTrialButton size="lg" className="text-lg h-14 px-8" showSubtext />
...
{/* Below-fold image: lazy load with explicit dimensions */}
            <img 
              ...
              decoding="async"
            />
            <span>&copy; 2026 Phi Sigma Kappa Tutor</span>
          </div>
