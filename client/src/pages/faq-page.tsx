        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Everything you need to know about Phi Sigma Kappa Tutor
            </p>
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="faq-1" className="border rounded-lg px-6 bg-card">
              <AccordionTrigger className="text-lg font-medium hover:text-primary text-left" data-testid="faq-trigger-1">
                What's the difference between Phi Sigma Kappa Tutor and ChatGPT or other AI chatbots?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground leading-relaxed" data-testid="faq-content-1">
                Most AI chat tools are text-only—they answer questions but don't actually teach. <strong>Phi Sigma Kappa Tutor</strong> was built for real learning. It uses a powerful conversational voice engine that allows natural, two-way dialogue. The tutor remembers what you're studying, adapts to your level, and walks you step-by-step through problems in math, English, science, and more. Think of ChatGPT as an assistant; Phi Sigma Kappa Tutor is your personal tutor that listens, speaks, and guides you in real time.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="faq-2" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed" data-testid="faq-content-2">
                Phi Sigma Kappa Tutor's voice engine lets you talk naturally—simply ask a question aloud, and the tutor responds instantly. No typing, no delays—just a smooth back-and-forth conversation like having a live teacher beside you.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="faq-4" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed" data-testid="faq-content-4">
                Nearly every subject and level is supported right now—from kindergarten to graduate school. Whether it's math, English, science, Spanish, or specialized study help, Phi Sigma Kappa Tutor adapts to each learner's needs.
              </AccordionContent>
            </AccordionItem>
