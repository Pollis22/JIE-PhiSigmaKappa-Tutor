      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="space-y-6">
            <div className="flex gap-4 bg-gray-50 p-6 rounded-lg">
              <div className="flex-shrink-0">
                <Volume2 className="w-8 h-8 text-[#B71234]" />
              </div>
              <div>
            ...
            <div className="flex gap-4 bg-gray-50 p-6 rounded-lg">
              <div className="flex-shrink-0">
                <Monitor className="w-8 h-8 text-[#B71234]" />
              </div>
              <div>
            ...
            <div className="flex gap-4 bg-gray-50 p-6 rounded-lg">
              <div className="flex-shrink-0">
                <Headphones className="w-8 h-8 text-[#B71234]" />
              </div>
              <div>
            ...
            <div className="flex gap-4 bg-gray-50 p-6 rounded-lg">
              <div className="flex-shrink-0">
                <Wifi className="w-8 h-8 text-[#B71234]" />
              </div>
              <div>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border-2 border-[#B71234] rounded-lg p-6">
              <div className="flex items-center gap-3 mb-4">
                <MessageSquare className="w-8 h-8 text-[#B71234]" />
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
                <Lightbulb className="w-6 h-6 text-[#B71234]" />
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
              <div className="flex-shrink-0 w-8 h-8 bg-[#B71234] text-white rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div>
        ...
        <section>
          ...
          <div className="bg-gray-50 p-8 rounded-lg text-center">
            ...
            <button
              ...
              className="bg-[#B71234] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#A00409] transition-colors"
            >
