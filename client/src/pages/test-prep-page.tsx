        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div
              ...
              onClick={() => setLocation("/")}
            >
              <img src={suLogo} alt="Phi Sigma Kappa" className="h-12 w-auto" />
              ...
              <CardContent className="pt-6">
                ...
                <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                  <p className="text-xs text-amber-700 dark:text-amber-300">
                    <strong>Our recommendation:</strong> Use Phi Sigma Kappa Tutor as a supplement to your primary study plan. 
      ...
      <section className="py-16 md:py-20 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
            Your exam is not going to wait. Start preparing with your Phi Sigma Kappa Tutor today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => setLocation("/")} className="text-lg h-14 px-8">Start a Test Prep Session</Button>
            <Button size="lg" variant="outline" onClick={() => setLocation("/features")} className="text-lg h-14 px-8">
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center space-x-2">
            <img src={suLogo} alt="Phi Sigma Kappa" className="h-10 w-auto" />
            <span className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} Phi Sigma Kappa · AI Tutor Program</span>
          </div>
