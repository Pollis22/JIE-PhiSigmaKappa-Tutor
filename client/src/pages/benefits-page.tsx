  ...
  return (
    <div className="min-h-screen bg-background font-sans selection:bg-primary/10">
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Why Families Choose Phi Sigma Kappa Tutor for Homework Help</h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-lg text-muted-foreground">A voice tutor for Brothers covering the breadth of college and graduate scholarship — from undergraduate coursework to GRE, GMAT, LSAT, and MCAT preparation.</p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How Phi Sigma Kappa Tutor Works</h2>
      ...
      <footer className="py-12 border-t border-border">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-muted-foreground">
          <div className="flex items-center space-x-2">
            <img src={suLogo} alt="Phi Sigma Kappa Tutor" className="h-6 w-auto grayscale opacity-50" />
            <span>&copy; 2026 Phi Sigma Kappa Tutor. All rights reserved.</span>
          </div>
