        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#B71234]/80 via-[#B71234]/60 to-[#B71234]/90 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <button
              ...
              className="bg-white text-[#B71234] px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Get Started
            </button>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#B71234]">
              <Clock className="w-12 h-12 text-[#B71234] mb-4" />
            ...
            <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#B71234]">
              <Globe className="w-12 h-12 text-[#B71234] mb-4" />
            ...
            <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#B71234]">
              <Zap className="w-12 h-12 text-[#B71234] mb-4" />
            ...
            <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#B71234]">
              <Users className="w-12 h-12 text-[#B71234] mb-4" />
            ...
            <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#B71234]">
              <TrendingUp className="w-12 h-12 text-[#B71234] mb-4" />
            ...
            <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-[#B71234]">
              <Award className="w-12 h-12 text-[#B71234] mb-4" />
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/3 flex justify-center">
                <MessageSquare className="w-32 h-32 text-[#B71234]" />
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8">
              <div className="md:w-1/3 flex justify-center">
                <Upload className="w-32 h-32 text-[#B71234]" />
              </div>
              <div className="md:w-2/3">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/3 flex justify-center">
                <Camera className="w-32 h-32 text-[#B71234]" />
              </div>
              <div className="md:w-2/3">
            ...
            <div id="test-prep" className="flex flex-col md:flex-row-reverse items-center gap-8 scroll-mt-20">
              <div className="md:w-1/3 flex justify-center">
                <BookOpen className="w-32 h-32 text-[#B71234]" />
              </div>
              <div className="md:w-2/3">
        ...
        <div className="text-center">
          ...
          <button
            onClick={() => setLocation("/auth")}
            className="bg-[#B71234] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#A00409] transition-colors"
          >
            Start Learning Now
          </button>
          <p className="text-gray-600 mt-4">
            Questions? <button onClick={() => setLocation("/contact")} className="text-[#B71234] hover:underline">Contact Us</button>
          </p>
        </div>
      </div>
    </div>
