      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="space-y-4">
            <details className="bg-gray-50 p-6 rounded-lg">
              <summary className="font-bold text-lg cursor-pointer flex items-center gap-2">
                <HelpCircle className="w-5 h-5 text-[#B71234]" />
            ...
            <details className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="mt-4 text-gray-700 ml-7">
                Undergraduate coursework across the humanities and sciences, plus graduate test preparation (GRE, GMAT, LSAT, MCAT). The tutor supports mathematics, science, humanities, and twenty-five languages.
              </p>
            </details>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <button onClick={() => setLocation("/best-practices")}>
              <div className="bg-gray-50 p-6 rounded-lg border-2 border-transparent hover:border-[#B71234] transition-colors cursor-pointer text-left">
                <Book className="w-12 h-12 text-[#B71234] mb-4" />
            ...
            <button onClick={() => setLocation("/features")}>
              <div className="bg-gray-50 p-6 rounded-lg border-2 border-transparent hover:border-[#B71234] transition-colors cursor-pointer text-left">
                <MessageCircle className="w-12 h-12 text-[#B71234] mb-4" />
        ...
        <section>
          <div className="bg-gray-50 p-8 rounded-lg text-center">
            <Mail className="w-12 h-12 text-[#B71234] mx-auto mb-4" />
