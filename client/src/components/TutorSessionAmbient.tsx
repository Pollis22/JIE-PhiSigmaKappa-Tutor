...
const GALLERY = [
  { src: buckyClassroom, caption: "Learning at Phi Sigma Kappa" },
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
          <img
            ...
            style={{
              width: 140,
              height: "auto",
              filter: "drop-shadow(0 4px 16px rgba(183,18,52,0.25))",
        ...
        <div className="relative flex items-center justify-center" style={{ width: 72, height: 72 }}>
          ...
          <div
            ...
            style={{
              width: 64,
              height: 64,
              background: `radial-gradient(circle at 35% 35%, white 0%, rgba(183,18,52,0.15) 60%, rgba(183,18,52,0.35) 100%)`,
              boxShadow: `0 0 0 3px rgba(183,18,52,0.12), 0 4px 20px rgba(183,18,52,0.2)`,
              border: `2px solid rgba(183,18,52,0.2)`,
            }}
          >
            <img src={suLogo} alt="Phi Sigma Kappa" style={{ width: 44, height: "auto", objectFit: "contain" }} />
          </div>
        </div>
      ...
      <div
        ...
        style={{
          background: isConnected ? "rgba(183,18,52,0.1)" : "rgba(100,100,120,0.08)",
          color: isConnected ? UW_RED : "#888",
          border: `1px solid ${isConnected ? "rgba(183,18,52,0.2)" : "rgba(100,100,120,0.15)"}`,
      ...
      <div
        ...
        style={{
          ...
          border: "1px solid rgba(183,18,52,0.12)",
          boxShadow: "0 2px 12px rgba(183,18,52,0.06)",
          opacity: visible ? 1 : 0,
