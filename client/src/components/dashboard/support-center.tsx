  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Get help with Phi Sigma Kappa Tutor</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <TabsContent value="contact" className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                ...
                <a href="mailto:support@phisigmakappa.org" className="font-medium underline">
                  support@phisigmakappa.org
                </a>
              </AlertDescription>
            </Alert>
            ...
            <div className="mt-6 p-4 bg-muted/50 rounded-lg">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">support@phisigmakappa.org</span>
                </div>
                <div className="flex items-center gap-2">
