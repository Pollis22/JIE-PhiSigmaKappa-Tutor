...
export function NavigationHeader() {
  ...
  return (
    <nav style={{ background: "#FFFFFF", borderBottom: "1px solid #E8E8E8", position: "sticky", top: 0, zIndex: 50 }}>
      ...
      <div style={{ height: 4, background: "#B71234" }} />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-3">
          {/* Logo */}
          <div className="flex items-center gap-3 cursor-pointer flex-shrink-0" onClick={() => setLocation("/tutor")}>
            <img src={pskShield} alt="Phi Sigma Kappa Fraternity" style={{ height: 44 }} />
            <div className="hidden sm:block" style={{ borderLeft: "1px solid #DAD7CB", paddingLeft: 12 }}>
              <div style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 16, color: "#1A1A1A", lineHeight: 1.1, whiteSpace: "nowrap" }}>Phi Sigma Kappa</div>
              <div style={{ fontSize: 9, color: "#646569", fontWeight: 500, letterSpacing: 1, textTransform: "uppercase", whiteSpace: "nowrap" }}>The Cardinal Tutor</div>
            </div>
          </div>
            ...
            {navLinks.map(item => (
              <button
                ...
                style={{
                  ...
                  color: isActive(item.path) ? "#B71234" : "#646569",
            ...
            {navLinks.map(item => (
              <button
                ...
                style={{
                  ...
                  fontSize: 15,
                  fontWeight: isActive(item.path) ? 600 : 500,
                  color: isActive(item.path) ? "#B71234" : "#282728",
                  background: isActive(item.path) ? "rgba(183,18,52,0.06)" : "transparent",
                  border: "none",
                  cursor: "pointer",
                  fontFamily: "'Open Sans', system-ui, sans-serif",
