...
export function LiveChatWidget() {
  ...
  // Phi Sigma Kappa Tutor Support Agent ID
  const agentId = import.meta.env.VITE_ELEVENLABS_SUPPORT_AGENT_ID as string | undefined;

  const conversation = useConversation({
    onConnect: () => {
      console.log('[LiveChat] Connected to Phi Sigma Kappa Tutor Support');
      setError(null);
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-[380px] h-[550px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200">
          <div className="text-white p-4 flex justify-between items-center" style={{ background: 'linear-gradient(135deg, #B71234 0%, #A00409 100%)' }}>
            ...
            {messages.map((msg, index) => (
              ...
              >
                <div
                  ...
                  style={msg.role === 'user' ? { background: '#B71234' } : {}}
                >
              ...
              <div className="flex justify-start">
                <div className="bg-white rounded-2xl px-4 py-2 shadow-sm border border-gray-100">
                  <div className="flex items-center gap-1">
                    <div className="w-2 h-2 rounded-full animate-bounce" style={{ background: '#B71234', animationDelay: '0ms' }} />
                    <div className="w-2 h-2 rounded-full animate-bounce" style={{ background: '#B71234', animationDelay: '150ms' }} />
                    <div className="w-2 h-2 rounded-full animate-bounce" style={{ background: '#B71234', animationDelay: '300ms' }} />
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <button
                  ...
                  style={isMuted ? { background: '#B71234' } : {}}
              ...
              <button
                ...
                style={{ background: '#FEE2E2', color: '#B71234' }}
