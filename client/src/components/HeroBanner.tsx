...
export function HeroBanner({ mounted = false }: Props) {
  ...
  // SRM-first messaging — 8 rotating slides, Phi Sigma Kappa imagery throughout.
        ...
        {slides.map((slide, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-6 pr-40">
              ...
              >
                <img src={pskShield} alt="" className="h-5 w-auto" style={{ filter: "brightness(0) invert(1)" }} />
                <span className="text-white text-xs font-bold tracking-widest uppercase">Phi Sigma Kappa</span>
              </div>
              <h2
