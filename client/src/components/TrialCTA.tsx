          ...
          <form onSubmit={handleSubmit} className="space-y-4 py-4">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 mt-2" data-testid="notice-trial-demo">
              <p className="text-xs text-gray-500 leading-relaxed" style={{ fontSize: '12px' }}>
                <span className="font-medium text-gray-600">Free Trial Notice:</span> This trial runs in a lightweight demo mode for speed and reliability. To unlock the full Phi Sigma Kappa Tutor experience (profiles, more subjects, saved history, and full features), create a full account.
              </p>
            </div>
