    ...
    <div className="mt-4 rounded-xl border border-border bg-card overflow-hidden shadow-sm">
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <span className="hidden sm:inline text-xs text-muted-foreground font-normal">— Help us improve your Phi Sigma Kappa Tutor</span>
        </div>
          ...
          {submitted ? (
            ...
            <div className="flex flex-col items-center justify-center py-6 gap-3 text-center">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">Your input helps us improve the Phi Sigma Kappa Tutor experience.</p>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="flex items-center justify-between">
                <p className="text-xs text-muted-foreground">
                  Sent privately to the Phi Sigma Kappa Tutor team
                </p>
                <button
