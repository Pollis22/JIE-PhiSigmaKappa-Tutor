...
<p style="margin:0 0 30px 0;color:#333333;font-size:16px;line-height:24px;font-family:Arial,Helvetica,sans-serif;">Thank you for your interest in Phi Sigma Kappa Tutor. Click the button below to verify your email and start your 5-minute free trial.</p>
...
Thank you for your interest in Phi Sigma Kappa Tutor.
...
If you didn't request this, you can safely ignore this email.`;
    ...
    await this.emailService.sendEmail({
      to: email,
      subject: 'Verify your email for Phi Sigma Kappa Tutor Free Trial',
      html: htmlContent,
      text: textContent,
    });
  }
...
<h2 style="margin:0 0 20px 0;color:#dc2626;font-size:22px;">New Phi Sigma Kappa Tutor Free Trial Started</h2>
...
<a href="${adminPanelLink}" style="display:inline-block;padding:10px 20px;font-size:14px;color:#ffffff;text-decoration:none;background-color:#dc2626;border-radius:4px;">View in Admin Panel</a>
    ...
    const textContent = `New Phi Sigma Kappa Tutor Free Trial Started
...
View in Admin Panel: ${adminPanelLink}`;
    ...
    await this.emailService.sendEmail({
      to: adminEmail,
      subject: 'New Phi Sigma Kappa Tutor Free Trial Started',
      html: htmlContent,
      text: textContent,
    });
  ...
  async requestMagicLink(email: string): Promise<MagicLinkRequestResult> {
    try {
      ...
      if (!entitlement.hasAccess) {
        ...
        return { ok: false, code: 'TRIAL_EXHAUSTED', error: 'Your trial has ended. Please sign up to continue using Phi Sigma Kappa Tutor.' };
      }
...
<p style="margin:0 0 20px 0;color:#333333;font-size:16px;line-height:24px;">Great news! We've added <strong>${extensionMinutes} more minutes</strong> to your Phi Sigma Kappa Tutor trial.</p>
...
Great news! We've added ${extensionMinutes} more minutes to your Phi Sigma Kappa Tutor trial.
...
Ready to unlock unlimited learning? View our plans: ${baseUrl}/pricing`;
    ...
    try {
      ...
      await emailService.sendEmail({
        to: email,
        subject: 'Your Phi Sigma Kappa Tutor Trial Has Been Extended!',
        html: htmlContent,
        text: textContent,
      });
...
<p style="margin:0 0 30px 0;color:#333333;font-size:16px;line-height:24px;font-family:Arial,Helvetica,sans-serif;">Click the button below to sign in and continue your Phi Sigma Kappa Tutor free trial.</p>
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 30px 0;">
<tr>
<td align="center">
<!--[if mso]>
...
Click the link below to sign in and continue your Phi Sigma Kappa Tutor free trial:
...
If you didn't request this, you can safely ignore this email.`;
    ...
    await this.emailService.sendEmail({
      to: email,
      subject: 'Continue Your Phi Sigma Kappa Tutor Free Trial',
      html: htmlContent,
      text: textContent,
    });
  }
  ...
  private async sendVerificationReminderEmail(email: string, token: string, reminderNumber: number): Promise<void> {
    ...
    const subject = reminderNumber === 1 
      ? 'Reminder: Complete your Phi Sigma Kappa Tutor Free Trial signup'
      : 'Final Reminder: Your Phi Sigma Kappa Tutor Free Trial is waiting';
