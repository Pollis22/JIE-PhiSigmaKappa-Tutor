  ...
  async sendWelcomeEmail(user: {
    ...
    try {
      ...
      await resend.emails.send({
        from: fromEmail,
        to: user.email,
        subject: 'Welcome to Phi Sigma Kappa Tutor!',
        html: `
      ...
      const html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="text-align: center; color: #9ca3af; font-size: 12px; margin-top: 16px;">
            Phi Sigma Kappa Tutor - Admin Notification System
          </p>
        </div>
      `;
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  ...
                  <tr>
                    <td style="background: linear-gradient(135deg, #C41E3A 0%, #8B0000 100%); padding: 30px; text-align: center;">
                      <img src="${logoUrl}" alt="Phi Sigma Kappa Tutor" width="150" style="max-width: 150px; height: auto;">
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for signing up for Phi Sigma Kappa Tutor! Your payment has been processed successfully.</p>
              ...
              <p>If you didn't create an account with Phi Sigma Kappa Tutor, you can safely ignore this email.</p>
              
              <p>Welcome to the family!<br><strong>The Phi Sigma Kappa Tutor Team</strong></p>
            </div>
            
            <div class="footer">
              <p><strong>Phi Sigma Kappa Tutor</strong> | Patent Pending System</p>
...
Thank you for signing up for Phi Sigma Kappa Tutor! Your payment has been processed successfully.
...
The Phi Sigma Kappa Tutor Team`;
      
      await resend.emails.send({
        from: fromEmail,
        to: user.email,
        subject: '✓ Verify Your Email - Phi Sigma Kappa Tutor',
        html,
        text
      });
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>You signed up for Phi Sigma Kappa Tutor but haven't started your free trial yet. Your <strong>30 minutes of free AI tutoring</strong> is ready and waiting!</p>
              ...
              <p style="color: #666; font-size: 14px;">If you didn't sign up for Phi Sigma Kappa Tutor, you can safely ignore this email.</p>
              
              <p>We'd love to help you learn!<br><strong>The Phi Sigma Kappa Tutor Team</strong></p>
            </div>
...
You signed up for Phi Sigma Kappa Tutor but haven't started your free trial yet. Your 30 minutes of free AI tutoring is ready and waiting!
...
The Phi Sigma Kappa Tutor Team`;
      ...
      await resend.emails.send({
        from: fromEmail,
        to: params.email,
        subject: 'Your Phi Sigma Kappa Tutor free trial is waiting',
        html,
        text
      });
...
stateuniversity-tutor.ai
      ...
      await resend.emails.send({
        from: fromEmail,
        to: user.email,
        subject: 'Reset Your Password - Phi Sigma Kappa Tutor',
        html,
        text
      });
  ...
  async sendContactForm(contact: {
    ...
    try {
      ...
      await resend.emails.send({
        from: fromEmail,
        to: contact.email,
        subject: 'We Received Your Message - Phi Sigma Kappa Tutor',
        html: `
          ...
          <p style="white-space: pre-wrap;">${contact.message}</p>
          <hr>
          <p>Best regards,<br>Phi Sigma Kappa Tutor Team</p>
          <p style="margin-top:24px;color:#666;font-size:14px;">
  ...
  async sendCancellationEmailToUser(params: {
    ...
    try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for being part of Phi Sigma Kappa Tutor. We hope to see you again!</p>
              
              <p>Warmly,<br>The Phi Sigma Kappa Tutor Team</p>
            </div>
            
            <div class="footer">
              <p><strong>Phi Sigma Kappa Tutor</strong></p>
      ...
      await resend.emails.send({
        from: fromEmail,
        to: email,
        subject: 'Your Phi Sigma Kappa Tutor Subscription Has Been Canceled',
        html,
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="margin-top: 20px;">The Phi Sigma Kappa Tutor Team</p>
            </div>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>The Phi Sigma Kappa Tutor Team</p>
            </div>
  ...
  async sendReactivationEmail(params: {
    ...
    try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Happy learning!<br><strong>The Phi Sigma Kappa Tutor Team</strong></p>
            </div>
      ...
      await resend.emails.send({
        from: fromEmail,
        to: email,
        subject: `🎉 Welcome Back to Phi Sigma Kappa Tutor!`,
        html,
  ...
  async sendSessionSummary(data: {
    ...
    try {
      ...
      await resend.emails.send({
        from: `Phi Sigma Kappa Tutor <${fromEmail}>`,
        to: data.parentEmail,
        ...
        html: `
          ...
          <body>
            <div class="container">
              ...
              <div class="footer">
                <p style="margin: 0;">Phi Sigma Kappa Tutor</p>
      ...
      const html = `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Phi Sigma Kappa Tutor &bull; Personalized Learning for Every Student</p>
              <p style="font-size:10px; color:#9ca3af; margin-top:8px;">
                This report is auto-generated by Phi Sigma Kappa Tutor and has not been reviewed by a licensed educator, 
