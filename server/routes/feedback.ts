      ...
      await emailService.sendEmail({
        ...
        html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
          <div style="background:#B71234;padding:20px 24px;border-radius:12px 12px 0 0;">
            <h1 style="color:white;margin:0;font-size:18px;">📬 Phi Sigma Kappa Tutor Feedback</h1>
          ...
          <div style="background:#fff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px;padding:20px 24px;">
            ...
            <div style="background:#f9fafb;border-left:4px solid #B71234;padding:14px 16px;border-radius:0 8px 8px 0;margin-top:12px;">
