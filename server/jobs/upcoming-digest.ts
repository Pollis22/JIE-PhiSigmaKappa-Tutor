/**
 * Upcoming-Work Digest Job (JIE Phi Sigma Kappa Tutor — Student SRM)
 * -----------------------------------------------------
...
function renderDigestEmail(params: {
  ...
  <div style="font-family:'Segoe UI',system-ui,-apple-system,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#f7f7f9;">
    <div style="background:#282728;padding:20px;border-radius:8px 8px 0 0;border-bottom:4px solid #B71234;">
      <h1 style="color:#fff;margin:0;font-size:20px;">Phi Sigma Kappa Tutor · Upcoming Work</h1>
    ...
    <div style="background:#fff;padding:20px;border-radius:0 0 8px 8px;">
      ...
      <div style="margin-top:24px;text-align:center;">
        <a href="${settingsUrl}"
           style="display:inline-block;background:#B71234;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;">
...
function renderAtRiskEmail(params: {
  ...
  <div style="font-family:'Segoe UI',system-ui,-apple-system,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#fff5f5;">
    <div style="background:#b00020;padding:20px;border-radius:8px 8px 0 0;">
      <h1 style="color:#fff;margin:0;font-size:20px;">Phi Sigma Kappa Tutor · Heads-Up Alert</h1>
    </div>
    <div style="background:#fff;padding:20px;border-radius:0 0 8px 8px;">
